   <?php
    ...
    $queryUpdate = "UPDATE tbl_reservas SET id_cliente='$id_cliente', fecha_entrega='$fecha_entrega', hora_entrega='$hora_entrega', fecha_recogida='$fecha_recogida', hora_recogida='$hora_recogida', tipo_plaza='$tipo_plaza', terminal_entrega='$terminal_entrega', terminal_recogida='$terminal_recogida', numero_vuelo_de_vuelta='$numero_vuelo_de_vuelta', servicio_adicional='$servicio_adicional', total_pago_reserva='$total_pago_reserva', total_pago_final='$total_pago_final', descuento='$descuento', observacion_cliente='$observacion_cliente', total_dias_reserva='$total_dias_reserva', servicios_extras1='$servicios_extras1', total_gasto_extras1='$total_gasto_extras1',
    servicios_extras2='$servicios_extras2', total_gasto_extras2='$total_gasto_extras2', servicios_extras3='$servicios_extras3', total_gasto_extras3='$total_gasto_extras3'
    WHERE id='$idReserva'";
    ...
    if ($resultUpdate) {
        $queryVehiculo = "UPDATE tbl_vehiculos SET id_cliente='$id_cliente', marca_car='$marca_car', modelo_car='$modelo_car', color_car='$color_car', matricula_car='$matricula_car'   WHERE matricula_car='$matricula_car'";
