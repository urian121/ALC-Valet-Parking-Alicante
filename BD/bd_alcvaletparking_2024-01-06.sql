...
# Tiempo de Generación: 2024-01-07 02:30:56 +0000
# ************************************************************
...
VALUES
	(1,'urian1213viera@gmail.com','$2y$10$4BGjpWNNaEtT.G.jnUENhevXws7gocLQ5q4KW.UJ2qCXXd8y0Z78W','urian viera','din','direcion completa','78787','Un Amigo','Observacion',1,0,'2024-01-06 20:28:06',NULL,'2023-11-07 03:00:03'),
	(3,'admin@gmail.com','$2y$10$l2FhdKzhkm7897RONVEjkumtfvmvJhsdAwJj.cEP9/QUf96FVcMyC','Administrador','44444','cra x','4444','Un Amigo','Soy administrador',1,1,'2024-01-07 03:03:32',NULL,'2023-11-11 00:26:45'),
	(15,'brenda@gmail.com','$2y$10$gPuxwk2KIg/yCuFMLJwqCOLEEqzojLPc54I.F7EScL3YXOYGlN1gO','Brenda','9980M','Bogota','45445445',NULL,'todo OK4',1,0,NULL,NULL,'2024-01-03 03:07:15');
...
CREATE TABLE `tbl_reservas` (
  ...
  `total_gasto_extras1` decimal(8,2) DEFAULT 0.00,
...
VALUES
	(1,1,'2024-01-24','05:40:00','Sin definir','No la sé','Plaza Cubierto','Aeropuerto de Alicante','Aeropuerto de Alicante',NULL,'Sin definir',0.00,NULL,0,NULL,'vuelo','oook',NULL,NULL,0.00,NULL,NULL,NULL,NULL,0,'2024-01-02 21:32:25'),
	(2,1,'2024-01-17','06:00:00','Sin definir','No la sé','Plaza Cubierto','Aeropuerto de Alicante','Aeropuerto de Alicante',NULL,'Sin definir',0.00,NULL,0,NULL,'10','obbb',NULL,NULL,0.00,NULL,NULL,NULL,NULL,1,'2024-01-06 15:05:38'),
	(3,1,'2024-01-10','05:40:00','Sin definir','No la sé','Plaza Cubierto','Aeropuerto de Alicante','Aeropuerto de Alicante','No','Sin definir',0.00,21.34,3,NULL,'1114','',NULL,'s1',10.00,'s2',12.00,'',0.00,0,'2024-01-06 21:12:46');
...
VALUES
	(1,15,'marca013','modelo013','color043','matricula543'),
	(2,1,'mara','modelo','cc','matri'),
	(3,2,'m','modelox','c','mat'),
	(4,1,'mara','modelo','cc','matri');
